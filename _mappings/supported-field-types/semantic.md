...
* `semantic` field type
  * == high-level abstraction /
    * simplifies OpenSearch's neural search setup 
    * can wrap >=1 field types 
      * _Example:_ ALL string & binary fields
    * 👀AUTOMATICALLY enables, -- based on -- configured ML model,👀
      * semantic indexing
      * querying
  * **PREREQUISITE**<br>
    * configure 
      * [local ML model / hosted | your OpenSearch cluster](/opensearch-documentation/_ml-commons-plugin/using-ml-models.md) OR
        * | [pretrained dense models](/opensearch-documentation/_ml-commons-plugin/pretrained-models.md#sentence-transformers),
          * default model configuration,
            * `knn_vector.`
              * `dimension`
              * `space_type`
      * [externally hosted model / -- connected to -- your OpenSearch cluster](/opensearch-documentation/_ml-commons-plugin/remote-models/index.md)
        * requirements 
          * | model configuration, EXPLICITLY define `knn_vector.`
            * `dimension` 
            * `space_type`

## Parameters

* == `semantic` field type's ALLOWED parameters

| Parameter                        | Data type                | Updatable | Required/Optional | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|----------------------------------|--------------------------|-----------|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `type`                           | String                   | No        | Required          | == `semantic`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
